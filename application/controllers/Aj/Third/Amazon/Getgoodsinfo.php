...
class Aj_Third_Amazon_GetgoodsinfoController extends AbstractController{
	public $authorize = self::MAYBELOGIN;
	public function indexAction(){
		$ASIN = Comm_Context::post('ASIN');
		...
		if(empty($ASIN)){
			...
			$data['goodsImg'] = str_replace('75', '300', $matchingProductForIdResult['AttributeSets']['ns2:ItemAttributes']['ns2:SmallImage']['ns2:URL']);
