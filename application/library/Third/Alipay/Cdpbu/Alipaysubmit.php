 ...
 */
class Third_Alipay_Cdpbu_Alipaysubmit{
	var $alipay_config;
	/**
	 *支付宝网关地址（新）
	 */
	...
	function buildRequestMysign($para_sort) {
		...
		switch (strtoupper(trim($this->alipay_config['sign_type']))) {
			case "MD5" :
				$mysign = self::md5Sign($prestr, $this->alipay_config['key']);
				break;
			default :
				$mysign = "";
		}
	...
	function buildRequestHttp($para_temp) {
		...
		//远程获取数据
		$sResult = self::getHttpResponsePOST($this->alipay_gateway_new, $this->alipay_config['cacert'],$request_data,trim(strtolower($this->alipay_config['input_charset'])));
	...
	function buildRequestHttpInFile($para_temp, $file_para_name, $file_name) {
		...
		//远程获取数据
		$sResult = self::getHttpResponsePOST($this->alipay_gateway_new, $this->alipay_config['cacert'],$para,trim(strtolower($this->alipay_config['input_charset'])));
